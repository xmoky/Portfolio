    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (session != null) {
            ...
            if ("admin".equals(tipoUsuario)) {
                // Generate HTML content based on the ResultSet
                try ( PrintWriter out = response.getWriter()) {
                    out.println("<!DOCTYPE html>");
                    out.println("<html>");
                    out.println("<head>");
                    out.println("<link rel=\"stylesheet\" href=\"estilos.css\"/>");
                    out.println("<title>Servlet BorraServlet</title>");
                    out.println("</head>");
                    out.println("<body>");
                    out.println("<form action='borradodeConsola' method='post'>\n"
                    ...
                    try ( PreparedStatement elStatementPreparado = laConexion.prepareStatement(
                        ...
                        out.println("</select>\n"
                                + "        <button type='submit'>Borrar consola</button>\n"
                                + "    </form>");
                        out.println("</body>");
                        out.println("</html>");
                    }
